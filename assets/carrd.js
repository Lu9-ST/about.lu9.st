(function () {
    ...
    (function () {
        ...
        new videoBackground("bg", { target: "#bg", src: "assets/bg.mp4", poster: "assets/bg.mp4.jpg", position: "bottom", loop: true });
    })();
    onvisible.add("#aboutheader", { style: "fade-up", speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
    onvisible.add("#aboutheader-ptbr", { style: "fade-up", speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
    onvisible.add("#btn-en", { style: "fade-in", speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
    onvisible.add("#btn-ptbr", { style: "fade-in", speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
    onvisible.add("#nav-en", { style: "flip-forward", speed: 1000, intensity: 10, threshold: 3, delay: 0, stagger: 125, staggerSelector: ":scope > li", replay: false });
    onvisible.add("#nav-ptbr", { style: "flip-forward", speed: 1000, intensity: 10, threshold: 3, delay: 0, stagger: 125, staggerSelector: ":scope > li", replay: false });
    onvisible.add("#links-en", { style: "fade-right", speed: 500, intensity: 4, threshold: 3, delay: 0, stagger: 125, staggerSelector: ":scope > li", replay: false });
    onvisible.add("#links-ptbr", { style: "fade-right", speed: 500, intensity: 4, threshold: 3, delay: 0, stagger: 125, staggerSelector: ":scope > li", replay: false });
    onvisible.add("#g88x31a", { style: "pop-in", speed: 250, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: "random", staggerSelector: ":scope ul > li", replay: false });
    onvisible.add("#g88x31b", { style: "pop-in", speed: 250, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: "random", staggerSelector: ":scope ul > li", replay: false });
    onvisible.add("#g88x31c", { style: "pop-in", speed: 250, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: "random", staggerSelector: ":scope ul > li", replay: false });
    onvisible.add("#g88x31d", { style: "pop-in", speed: 250, intensity: 5, threshold: 5, delay: 0, stagger: 125, staggerOrder: "random", staggerSelector: ":scope ul > li", replay: false });
    onvisible.add("#icons02", { style: "fade-down", speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
    onvisible.add("#icons01", { style: "fade-down", speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
    ready.run();
})();
